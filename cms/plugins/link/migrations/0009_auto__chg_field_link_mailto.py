...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('cmsplugin_link', 'mailto', self.gf('django.db.models.fields.EmailField')(max_length=255, null=True, blank=True))


    def backwards(self, orm):
        
        # Changing field 'Link.mailto'
        db.alter_column('cmsplugin_link', 'mailto', self.gf('models.EmailField')(max_length=75, null=True, blank=True))
    ...
    models = {
        ...
        'link.link': {
            ...
            'mailto': ('django.db.models.fields.EmailField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
